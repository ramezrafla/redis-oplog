  ...
  _.extend(proto, {
    ...
    startCaching(timeout) {
      ...
      const find = (selector = {}, options = {}) => {
        ...
        const cursor = Originals.find.call(this, selector, _.omit(options, 'fields'))
    ...
    fetchInCacheFirst(ids, options = {}) {
      ...
      if (notFoundIds.length) {
        const newResult = _.compact(Originals.find.call(this, {_id:{$in:notFoundIds}}, _.omit(options, 'fields')).fetch())
