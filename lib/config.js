const Config = {
  ...
  raceDetectionDelay: 300, // how long until all mongo nodes are assumed to have been replicated
  raceDetectionFieldsToSkip: {},
  raceDetection: null, // if set to false will disable race detection when secondaryReads = true
  redisExtras: {
