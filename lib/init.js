...
export default (config = {}) => {
  ...
  if (Config.secondaryReads === null && /readPreference=secondary/.test(process.env.MONGO_URL)) Config.secondaryReads = true

  if ((Config.secondaryReads && Config.raceDetection !== false) || Config.raceDetection) initializeRaceDetectionManager()
